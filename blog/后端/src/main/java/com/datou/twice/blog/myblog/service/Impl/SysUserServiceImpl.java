...
import com.datou.twice.blog.myblog.dao.mapper.SysUserMapper;
...
import com.datou.twice.blog.myblog.vo.LoginUserVo;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Override
    public SysUser findUserById(Long sysUserId) {
        SysUser sysUser = sysUserMapper.selectById(sysUserId);
        if(sysUser == null){
            sysUser = new SysUser();
            sysUser.setNickname("daTouJo");
        }
        return sysUser;
    }
