...
subroutine GaussSeidel_sub(n, tol, maxiter, iter, dumax, nthreads)
    ! Implements 2d GS_Serial iteration on n by n grid
...
end subroutine GaussSeidel_sub
