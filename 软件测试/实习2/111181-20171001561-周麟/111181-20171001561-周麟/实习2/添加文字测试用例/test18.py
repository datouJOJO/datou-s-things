...
class Test():
  ...
  def test_(self):
    ...
    actions.double_click(element).perform()
    ActionChains(self.driver).move_by_offset(15, 15).perform()

    actions.double_click(element).perform()
    ActionChains(self.driver).move_by_offset(20, 20).perform()

    actions.double_click(element).perform()
    ActionChains(self.driver).move_by_offset(25, 25).perform()

    actions.double_click(element).perform()
    ActionChains(self.driver).move_by_offset(5, 25).perform()
