...
driver.find_element_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget'
                             ...
                             '.HorizontalScrollView/android.widget.LinearLayout/android.view.ViewGroup[3]').click()
time.sleep(2)
...
el3 = driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget"
                                   ...
                                   "2]/android.view.ViewGroup/androidx.viewpager.widget.ViewPager/android.widget"
                                   ".FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView"
                                   "/android.widget.FrameLayout/android.widget.HorizontalScrollView/android.view"
                                   ".ViewGroup/android.widget.LinearLayout[1]/android.widget.ImageView")
el3.click()
time.sleep(2)
driver.back()
el4 = driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget"
                                   ...
                                   ".FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView"
                                   "/android.widget.FrameLayout/android.widget.HorizontalScrollView/android.view"
                                   ".ViewGroup/android.widget.LinearLayout[2]/android.widget.ImageView")
el4.click()
time.sleep(2)
driver.back()
el5 = driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget"
                                   ...
                                   ".FrameLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView"
                                   "/android.widget.FrameLayout/android.widget.HorizontalScrollView/android.view"
                                   ".ViewGroup/android.widget.LinearLayout[3]/android.widget.ImageView")
el5.click()
time.sleep(2)
driver.quit()
