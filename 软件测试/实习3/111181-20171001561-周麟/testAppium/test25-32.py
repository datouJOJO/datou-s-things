...
el1 = driver.find_element_by_xpath(
    ...
    ".ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/android.widget.FrameLayout/android.widget"
...
el2 = driver.find_element_by_xpath(
    ...
    ".FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout[5]")
el2.click()
time.sleep(2)
driver.back()
...
el4 = driver.find_element_by_xpath(
    ...
    ".widget.ViewPager/android.widget.RelativeLayout/android.view.ViewGroup/android.widget.RelativeLayout/androidx"
    ".recyclerview.widget.RecyclerView/android.widget.RelativeLayout[1]/android.widget.FrameLayout["
    "1]/android.widget.RelativeLayout/android.widget.TextView[2]")
el4.click()
time.sleep(2)
driver.back()
driver.back()
TouchAction(driver).press(x=543, y=2157).move_to(x=534, y=453).release().perform()
time.sleep(2)
el5 = driver.find_element_by_xpath(
    "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget"
    ".FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view"
    ".ViewGroup/android.widget.FrameLayout[1]/android.view.ViewGroup/android.widget.FrameLayout/android.widget"
    ".HorizontalScrollView/android.widget.LinearLayout/android.view.ViewGroup[3]")
el5.click()
time.sleep(2)
driver.quit()
